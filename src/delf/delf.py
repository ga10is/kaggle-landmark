...
# from https://github.com/nashory/DeLF-pytorch/blob/master/train/delf.py
...
class Delf_V1(nn.Module):
    ...
    def get_feature_at(self, modulename):
        return copy.deepcopy(self.end_points[modulename].detach().cpu())
    ...
    def forward_for_serving(self, x):
        ...
        ret_s = attn_score
        return ret_x.detach().cpu(), ret_s.detach().cpu()
